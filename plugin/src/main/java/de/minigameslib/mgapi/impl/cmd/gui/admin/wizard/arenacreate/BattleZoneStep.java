 ...
 * @author mepeisen
 */
public class BattleZoneStep implements WizardStepInterface<ArenaInterface>
{
     ...
     * @param arena
     */
    public BattleZoneStep(ArenaInterface arena)
    {
        this.arena = arena;
    }
    ...
    public void checkLocation(AbstractWizard<ArenaInterface> wizard) throws McException
    {
        ...
        {
            throw new McException(AbstractArenaZoneHandler.Messages.NotWithinMainZone, "battle"); //$NON-NLS-1$
        }
    }
    ...
    {
        arena.createZone(new Cuboid(this.lowLoc, this.highLow), BasicZoneTypes.Battle).setName("battle"); //$NON-NLS-1$
    }
     ...
     * @author mepeisen
     */
    @LocalizedMessages(value = "admingui.wizard.arena_create.BattleZoneStep")
    public enum Messages implements LocalizedMessageInterface
    {
         ...
         * help button
         */
        @LocalizedMessageList({"Select the battle zone.", "This is the area where the action goes on."})
         ...
         */
        @LocalizedMessage(defaultMessage = "Select low location for battle zone")
         ...
         * low location.
         */
        @LocalizedMessageList("Use the pinion and click the lower edge of your battle zone.")
        @MessageComment({"low location"})
         ...
         */
        @LocalizedMessage(defaultMessage = "Select high location for battle zone")
         ...
         * high location.
         */
        @LocalizedMessageList("Use the pinion and click the higher edge of your battle zone.")
        @MessageComment({"high location"})
