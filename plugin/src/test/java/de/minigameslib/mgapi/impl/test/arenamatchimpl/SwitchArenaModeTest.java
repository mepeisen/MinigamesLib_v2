 ...
 *
 */
public class SwitchArenaModeTest
{
    ...
    public void testInitBeforeMatch() throws McException
    {
        ...
        when(arena.getInternalName()).thenReturn("FOO"); //$NON-NLS-1$
        ...
        verify((ArenaPlayerImpl)player1, times(1)).switchArenaOrMode("FOO", false); //$NON-NLS-1$
        
        verify((ArenaPlayerImpl)player1, times(1)).switchArenaOrMode(null, false);
    }
    ...
    public void testInitBeforeMatch2() throws McException
    {
        ...
        verify((ArenaPlayerImpl)player1, times(1)).switchArenaOrMode("FOO", true); //$NON-NLS-1$
    ...
    public void testInitWithinMatch4() throws McException
    {
        ...
        verify((ArenaPlayerImpl)player2, times(1)).switchArenaOrMode("FOO", false); //$NON-NLS-1$
        
        verify((ArenaPlayerImpl)player2, times(1)).switchArenaOrMode(null, false);
    }
