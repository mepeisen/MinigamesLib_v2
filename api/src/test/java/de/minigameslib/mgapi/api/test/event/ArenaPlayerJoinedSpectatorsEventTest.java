 ...
 *
 */
public class ArenaPlayerJoinedSpectatorsEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final ArenaPlayerJoinedSpectatorsEvent evt = new ArenaPlayerJoinedSpectatorsEvent(arena, arenaplayer1, true);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ArenaPlayerJoinedSpectatorsEvent.getHandlerList());
    ...
    public void testTrueStub() throws McException
    {
        ...
        final ArenaPlayerInterface arenaplayer1 = mock(ArenaPlayerInterface.class);
        when(arenaplayer1.getMcPlayer()).thenReturn(player1);
        final ArenaPlayerJoinedSpectatorsEvent evt = new ArenaPlayerJoinedSpectatorsEvent(arena, arenaplayer1, false);
