 ...
 *
 */
public class ArenaStateChangedEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final ArenaStateChangedEvent evt = new ArenaStateChangedEvent(arena, ArenaState.Booting, ArenaState.Join);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ArenaStateChangedEvent.getHandlerList());
        assertSame(obj, evt.getObject());
        
        assertSame(arena, evt.getArena());
        
        assertEquals(ArenaState.Booting, evt.getOldState());
        assertEquals(ArenaState.Join, evt.getNewState());
    }
