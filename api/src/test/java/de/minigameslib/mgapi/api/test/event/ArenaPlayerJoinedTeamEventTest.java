 ...
 *
 */
public class ArenaPlayerJoinedTeamEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final ArenaPlayerJoinedTeamEvent evt = new ArenaPlayerJoinedTeamEvent(arena, arenaplayer1, CommonTeams.Aqua);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ArenaPlayerJoinedTeamEvent.getHandlerList());
        ...
        assertEquals(CommonTeams.Aqua, evt.getTeam());
    }
