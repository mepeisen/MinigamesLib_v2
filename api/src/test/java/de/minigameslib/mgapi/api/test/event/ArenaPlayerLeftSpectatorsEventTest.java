 ...
 *
 */
public class ArenaPlayerLeftSpectatorsEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final ArenaPlayerLeftSpectatorsEvent evt = new ArenaPlayerLeftSpectatorsEvent(arena, arenaplayer1);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ArenaPlayerLeftSpectatorsEvent.getHandlerList());
