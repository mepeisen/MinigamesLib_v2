 ...
 *
 */
public class ArenaLoseEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final ArenaLoseEvent evt = new ArenaLoseEvent(arena, new MatchResultImpl(5, false, uuid1, uuid2));
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ArenaLoseEvent.getHandlerList());
