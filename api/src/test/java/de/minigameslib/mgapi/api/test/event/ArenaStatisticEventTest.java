 ...
 *
 */
public class ArenaStatisticEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final MatchStatisticInterface stat = mock(MatchStatisticInterface.class);
        final ArenaStatisticEvent evt = new ArenaStatisticEvent(stat, arena);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ArenaStatisticEvent.getHandlerList());
