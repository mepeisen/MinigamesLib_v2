 ...
 *
 */
public class ArenaPlayerJoinSpectatorsEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final ArenaPlayerJoinSpectatorsEvent evt = new ArenaPlayerJoinSpectatorsEvent(arena, arenaplayer1, true);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ArenaPlayerJoinSpectatorsEvent.getHandlerList());
    ...
    public void testTrueStub() throws McException
    {
        ...
        final ArenaPlayerInterface arenaplayer1 = mock(ArenaPlayerInterface.class);
        when(arenaplayer1.getMcPlayer()).thenReturn(player1);
        final ArenaPlayerJoinSpectatorsEvent evt = new ArenaPlayerJoinSpectatorsEvent(arena, arenaplayer1, false);
