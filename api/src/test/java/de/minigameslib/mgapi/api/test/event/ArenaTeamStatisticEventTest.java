 ...
 *
 */
public class ArenaTeamStatisticEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final ArenaTeamStatisticEvent evt = new ArenaTeamStatisticEvent(arena, CommonTeams.Aqua, CommonMatchStatistics.Deaths, 1, 2);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ArenaTeamStatisticEvent.getHandlerList());
        assertSame(obj, evt.getObject());
        
        assertSame(CommonTeams.Aqua, evt.getTeam());
