...
import de.minigameslib.mgapi.api.rules.AbstractClassRule;
import de.minigameslib.mgapi.api.rules.ClassRuleSetType;
import de.minigameslib.mgapi.api.rules.ClassRuleSetInterface;

/**
 * Tests for {@link AbstractClassRule}.
 * 
 * @author mepeisen
 *
 */
public class AbstractClassRuleTest
{
    ...
    public void testCheck() throws McException
    {
        ...
        final ArenaClassInterface clazz = mock(ArenaClassInterface.class);
        when(clazz.getArena()).thenReturn(arena);
        final Rule rule = new Rule(type, clazz);
    ...
    public void testConstructor() throws McException
    {
        ...
        assertSame(clazz, rule.getArenaClass());
    }
    ...
    public void testRunInCopiedContext() throws McException, ClassNotFoundException
    {
        ...
        assertSame(rule, context.get(ClassRuleSetInterface.class));
    }
     ...
     * rule impl.
     */
    private static final class Rule extends AbstractClassRule
    {
         ...
         * @throws McException
         */
        public Rule(ClassRuleSetType type, ArenaClassInterface zone) throws McException
        {
            super(type, zone);
        }
        ...
        @Override
        public void onChoose(ArenaPlayerInterface player)
        {
            // empty
        }

        @Override
        public void onRemove(ArenaPlayerInterface player)
        {
            // empty
        }
