 ...
 *
 */
public class ArenaPlayerDieEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final ArenaPlayerDieEvent evt = new ArenaPlayerDieEvent(arena, arenaplayer1, 20d);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ArenaPlayerDieEvent.getHandlerList());
        ...
        assertEquals(20d, evt.getNewHealth(), 0);
        evt.setNewHealth(10d);
        assertEquals(10d, evt.getNewHealth(), 0);
        
        assertNull(evt.getNewSpawn());
        final ComponentIdInterface spawn = mock(ComponentIdInterface.class);
        evt.setNewSpawn(spawn);
        assertSame(spawn, evt.getNewSpawn());
    }
