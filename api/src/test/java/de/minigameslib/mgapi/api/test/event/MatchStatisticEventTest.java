...
import de.minigameslib.mgapi.api.events.MatchStatisticEvent;
 ...
 *
 */
public class MatchStatisticEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final MutableMatchStatisticInterface stat = mock(MutableMatchStatisticInterface.class);
        final MatchStatisticEvent evt = new MatchStatisticEvent(stat, arena);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), MatchStatisticEvent.getHandlerList());
        assertSame(obj, evt.getObject());
        
        assertSame(arena, evt.getArena());
        
        assertSame(stat, evt.getMatch());
    }
