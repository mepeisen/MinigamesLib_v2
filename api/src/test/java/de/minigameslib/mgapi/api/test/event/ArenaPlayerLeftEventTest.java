 ...
 *
 */
public class ArenaPlayerLeftEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final ArenaPlayerLeftEvent evt = new ArenaPlayerLeftEvent(arena, arenaplayer1);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ArenaPlayerLeftEvent.getHandlerList());
