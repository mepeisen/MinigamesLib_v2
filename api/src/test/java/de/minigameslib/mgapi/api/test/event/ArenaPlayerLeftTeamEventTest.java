 ...
 *
 */
public class ArenaPlayerLeftTeamEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final ArenaPlayerLeftTeamEvent evt = new ArenaPlayerLeftTeamEvent(arena, arenaplayer1, CommonTeams.Aqua);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ArenaPlayerLeftTeamEvent.getHandlerList());
