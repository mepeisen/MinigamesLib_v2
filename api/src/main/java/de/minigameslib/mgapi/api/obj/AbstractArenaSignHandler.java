 ...
 * @param <D> data class
 */
public abstract class AbstractArenaSignHandler<D extends AbstractObjectData<SignRuleSetType>> extends AbstractBaseArenaObjectHandler<SignRuleSetType, SignRuleSetInterface, D> implements ArenaSignHandler
{
    ...
    public Collection<CheckFailure> check()
    {
        ...
        for (final SignIdInterface id : mySigns)
        {
            ...
            result.add(new CheckFailure(
                    ...
                    Messages.SharedSign_Description));
        }
...
//                    Messages.ForeignEntity_Description));
    ...
    public enum Messages implements LocalizedMessageInterface
    {
        ...
        @LocalizedMessageList({
            "Your sign is not within a main zone.",
         ...
         */
        @LocalizedMessageList({
            "Your sign shares location with second sign.",
            "Although technical possible two signs cannot share the same location.",
            "It will be very confusing to choose which sign is responsible for updating the sign text."})
         ...
         */
        @LocalizedMessageList({
            "Your sign is set inside another zone from some foreign arena.",
            "Arena signs must not be located inside foreign arena zones because the rules can get confused."})
         ...
         */
        @LocalizedMessageList({
            "Your sign shares location with component from some foreign arena.",
            "Arena signs must not share their location with foreign components because the rules can get confused."})
         ...
         */
        @LocalizedMessageList({
            "Your sign shares location with sign from some foreign arena.",
            "Arena signs must not share their location with foreign signs because the rules can get confused."})
         ...
         */
        @LocalizedMessageList({
            "Your sign shares location with entity from some foreign arena.",
            "Arena signs must not share their location with foreign entities because the rules can get confused."})
