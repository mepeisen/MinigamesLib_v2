 ...
 * @author mepeisen
 * 
 * @see BasicWinningRuleSets#Points
 */
@ConfigurationValues(path = "core")
public enum PointsConfig implements ConfigurationValueInterface
{
    
    /**
     * the number of kills for winning
     */
    @ConfigurationInt(defaultValue = 10)
    @ConfigComment({"Number of kills for winning"})
    @ValidateLMin(1)
    PointsForWin,
